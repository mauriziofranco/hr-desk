...
public class AswerJsonResponse {
	...
	public String toString() {
		return "AswerJsonResponse [questionId=" + questionId + ", cansa=" + cansa + ", cansb=" + cansb + ", cansc="
				+ cansc + ", cansd=" + cansd + ", canse=" + canse + ", cansf=" + cansf + ", cansg=" + cansg + ", cansh="
				+ cansh + "]";
	}	
