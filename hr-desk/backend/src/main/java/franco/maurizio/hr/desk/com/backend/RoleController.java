...
public class RoleController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> getRoleById(@PathVariable final Long id){
	...
	public ResponseEntity<CeReProAbstractEntity> getRoleByLevel(@PathVariable final Integer level){
	...
	public ResponseEntity<CeReProAbstractEntity> updateRole(
            @PathVariable final Long id, @RequestBody Role role) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> deleteRole(@PathVariable final Long id) {
		Optional<Role> optRole = roleRepository.findById(id);
