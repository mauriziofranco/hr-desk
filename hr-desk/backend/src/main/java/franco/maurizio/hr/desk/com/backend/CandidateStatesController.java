...
public class CandidateStatesController {
	...
	public ResponseEntity<CeReProAbstractEntity> updateCandidateStates(@PathVariable final Long id,
		...
		if (currentCandidateStates.isEmpty()) {
	...
	@GetMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> getCandidateStatesById(@PathVariable final Long id) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> deleteCandidateStates(@PathVariable final Long id) {
		Optional<CandidateStates> candiStat = candidateStatesRepository.findById(id);
		if (candiStat.isEmpty()) {
			return new ResponseEntity<>(
