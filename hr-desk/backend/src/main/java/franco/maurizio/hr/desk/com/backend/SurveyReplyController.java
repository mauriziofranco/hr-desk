...
public class SurveyReplyController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> getSurveyReplyById(@PathVariable final Long id) {
	...
	public ResponseEntity<CeReProAbstractEntity> updateSurveyReply(@PathVariable final Long id,
			@RequestBody SurveyReply surveyReply) {

		Optional<SurveyReply> currentSurveyReply = surveyReplyRepository.findById(id);

		if (currentSurveyReply.isEmpty()) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<CeReProAbstractEntity> deleteSurveyReply(@PathVariable final Long id) {
		Optional<SurveyReply> surveyReply = surveyReplyRepository.findById(id);
		if (surveyReply.isEmpty()) {
			return new ResponseEntity<>(
